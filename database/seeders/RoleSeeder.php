...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       Permission::create(['name' => 'admin.users.edit','description'=>'asignar un rol'])->s([$role1]);
       ...
       Permission::create(['name' => 'admin.categories.edit','description'=>'editar de categoria'])->syncRoles([$role1]);
       Permission::create(['name' => 'admin.categories.destroy','description'=>'eliminar de categoria'])->syncRoles([$role1]);
