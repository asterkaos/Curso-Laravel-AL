<nav class="bg-gray-800" x-data="{open:false}">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
         <!-- boton notificacion-->
          ...
          <div class="ml-3 relative" x-data="{open:false}">
            <div>
              <button x-on:click="true" type="button" class="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
    ...
    <!-- menu movil -->
    <div class="sm:hidden" id="mobile-menu"x-on:click.away="open=false">
